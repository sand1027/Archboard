...
export default function TemplatesModal() {
  ...
  const { pushSnapshot, clearHistory } = useHistoryStore()
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
          <div>
            <h2 className="text-base font-semibold text-gray-900">Architecture Templates</h2>
            <p className="text-xs text-gray-500 mt-0.5">Start from a pre-built architecture</p>
          </div>
